# Data Connector Framework Skill 草案
...
本 Skill 草案用于实现 Data Connector Framework 的开发入口。它必须遵循 M5 Skill Engine，并引用既有 M2 Methodology、M3 Evidence、M4 Prompt 和 M6/M7 质量资产。
