# ADR - FEATURE-010 Autonomous Investment Committee
...
为该 Feature 生成独立 Feature Package，并将开发入口、架构决策、规格、Skill、Prompt、Schema、测试、Benchmark、PR Checklist 和 Release Notes 放在 `builder-output/autonomous-investment-committee/`。
