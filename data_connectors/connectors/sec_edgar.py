...
class SECEdgarConnector(BaseConnector):
    """Mock SEC / EDGAR Connector with Config/Input/Output/Error/Retry/Cache/Health/Test."""
    ...
    def _mock_raw(self, request: ConnectorRequest) -> dict[str, Any]:
        return {'filing_type': '10-K', 'company': 'Mock Company', 'period': 'FY2025', 'url': 'https://www.sec.gov/edgar/mock'}
