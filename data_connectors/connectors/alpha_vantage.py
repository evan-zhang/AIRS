...
CONFIG = {'connector_id': 'alpha_vantage',
 'name': 'Alpha Vantage',
...
INPUT_SCHEMA = {'type': 'object',
 ...
 'properties': {'symbol': {'type': 'string'}, 'function': {'type': 'string'}}}
OUTPUT_SCHEMA = {
    "type": "object",
...
TEST_CASE = {'input': {'symbol': 'MSFT', 'function': 'TIME_SERIES_DAILY'},
 'expect_fields': ['source', 'url', 'timestamp', 'version', 'trace_id']}


class AlphaVantageConnector(BaseConnector):
    """Mock Alpha Vantage Connector with Config/Input/Output/Error/Retry/Cache/Health/Test."""
    ...
    def _mock_raw(self, request: ConnectorRequest) -> dict[str, Any]:
        return {'symbol': 'MSFT', 'function': 'TIME_SERIES_DAILY', 'observations': 1, 'url': 'https://www.alphavantage.co/query'}
