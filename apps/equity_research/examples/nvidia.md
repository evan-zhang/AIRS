...
- Request ID：`APP-001-F44FD7FC1B`
- Symbol：`NVDA`
- Market：`US`
- Research Question：分析 NVDA NVIDIA 的财务、估值、供应链和风险
...
### Facts
- {'connector_id': 'yahoo_finance', 'source': 'Yahoo Finance', 'source_type': 'trusted_third_party', 'url': 'https://finance.yahoo.com/quote/AAPL', 'timestamp': '2026-07-10T10:39:04.047647+00:00', 'version': '0.1.0', 'trace_id': 'TRACE-C9837581F035', 'data': {'symbol': 'AAPL', 'currency': 'USD', 'last_price': 100.0, 'url': 'https://finance.yahoo.com/quote/AAPL'}, 'traceability': {'connector': 'yahoo_finance', 'request_id': 'TRACE-C9837581F035', 'cache_hit': False, 'transformations': ['mock_fetch', 'normalize']}, 'disclaimer': '仅供 AIRS 工程开发和研究质量控制使用，不构成投资建议。'}
...
### Facts
- Evidence Chain ID：chain-APP-001-F44FD7FC1B
...
### Facts
- Committee Session：aic-plan-APP-001-F44FD7FC1B
- Vote：FAIL
...
**Report ID**：reportgen-APP-001-F44FD7FC1B
**版本**：0.1.0
...
- Evidence 数量：5
- KG 引用：`kg-APP-001-F44FD7FC1B`
- Scorecard 引用：`score-app001-ev-01`

## 2. 研究问题与范围

分析 NVDA NVIDIA 的财务、估值、供应链和风险
...
### Facts
- Request：{'request_id': 'APP-001-F44FD7FC1B', 'raw_input': '分析 NVDA NVIDIA 的财务、估值、供应链和风险', 'symbol': 'NVDA', 'company_name': 'NVIDIA', 'market': 'US', 'time_range': '最近12个月', 'research_question': '分析 NVDA NVIDIA 的财务、估值、供应链和风险', 'focus_areas': ['financial', 'risk', 'supply_chain', 'valuation'], 'peer_companies': [], 'risk_preference': 'balanced', 'language': 'zh', 'created_at': '2026-07-10', 'disclaimer': '仅用于 AIRS 投资研究流程编排和质量控制，不构成投资建议。'}
- Company Traceability：{'resolver': 'apps/equity_research/company_resolver.py', 'input': {'request_id': 'APP-001-F44FD7FC1B', 'raw_input': '分析 NVDA NVIDIA 的财务、估值、供应链和风险', 'symbol': 'NVDA', 'company_name': 'NVIDIA', 'market': 'US', 'time_range': '最近12个月', 'research_question': '分析 NVDA NVIDIA 的财务、估值、供应链和风险', 'focus_areas': ['financial', 'risk', 'supply_chain', 'valuation'], 'peer_companies': [], 'risk_preference': 'balanced', 'language': 'zh', 'created_at': '2026-07-10', 'disclaimer': '仅用于 AIRS 投资研究流程编排和质量控制，不构成投资建议。'}}
